...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="container">
        <p style="color:crimson; text-transform: uppercase;"><strong>{{$title}}</strong></p>
        <hr>
    ...
    <div class="container">
        <table class="table table-bordered">
            ...
            <tbody>
                @if(count($resp) > 0)
                    @foreach($resp as $key => $pago)
                    <tr>
                        <td align="center">
                            {{ $pago->campania_id->cliente->Identificacion }}
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            {{ $pago->campania_id->cliente->Telefono }}
                        </td>
                        @if($pago->dias_vencidos)
                            <td align="center">
                                {{ $pago->dias_vencidos }}
                            </td>
                        @endif
                        ...
                        <td align="center">
                            {{ $pago->detallePagos[(count($pago->detallePagos) - 1)]->fecha_pago }}
                        </td>
                        <td align="center">
                            ${{ $pago->cuota }}
                        </td>
                        <td align="center">
                            ${{ $pago->detallePagos[(count($pago->detallePagos) - 1)]->cuota_fija }}
                        </td>
                    </tr>
                    @endforeach
                @endif
